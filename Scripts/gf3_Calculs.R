    ...
    mutate(
      Nha = case_when(
        ...
        Cat != "PER" & is.na(Type) &
          ...
          Diam1 < DiamLim & Diam1 >= DiamLim1 & Dist <= Rayon1 * CoeffPente ~
          # Nha = 
          10000 / pi / Rayon1 ^ 2,
...
gf_Calculs <- function(
  ...
  load("/Users/Valentin/Travail/Outils/Inventaire_PP/tables/algan_table.Rdata")
  ...
  load("/Users/Valentin/Travail/Outils/Inventaire_PP/tables/carbon_codes_tables.Rdata")
